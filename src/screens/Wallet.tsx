    ...
    return (
        <View style={styles.container}>
            ...
            >
                <View style={styles.card}>
                    ...
                    <View style={styles.description}>
                        <Text style={[styles.text]}>Close the month</Text>
                        <View style={{ flex: 1 }}>
                            <Text
                                numberOfLines={1}
                                style={[
            ...
            >
                <SafeAreaView style={[styles.container, { justifyContent: "space-between" }]}>
                    <Text style={[styles.text, { textAlign: "justify", marginTop: 45 }]}>
                        This will cause all your entries, exits, accounts receivable and debts that were recorded on dates prior to today to be deleted, but the balance in your wallet will remain the same.
                    </Text>
                    <TouchableOpacity
                        onPress={() => {
                            storeWalletSavings();
                    ...
                    >
                        <View style={[styles.button, { backgroundColor: "#CFF4CF", marginBottom: 45 }]}>
                            <Text style={[styles.text, { color: "#171717" }]}>Close the month</Text>
            ...
            >
                <SafeAreaView style={[styles.container, { justifyContent: "space-between" }]}>
                    <Text style={[styles.text, { textAlign: "justify", marginTop: 45 }]}>
                        Delete all your entries, exits, accounts receivable and debts, starting from scratch.
                    </Text>
                    <TouchableOpacity
                        onPress={() => {
                            resetAll();
                    ...
                    >
                        <View style={[styles.button, { backgroundColor: "#E2D5FE", marginBottom: 45 }]}>
                            <Text style={[styles.text, { color: "#171717" }]}>Clear all</Text>
                            <View style={[styles.image, { marginLeft: 20, marginRight: 0 }]}>
                                <Icon
                                    fill="#171717"
                                    height="37px"
