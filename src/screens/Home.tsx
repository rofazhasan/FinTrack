    ...
    return (
        <ScrollView style={styles.container}>
            <View style={styles.greetingsContainer}>
                ...
                >
                    <Text numberOfLines={1} style={styles.greetingsText}>Hello, {username ? username : "what is your name?"}</Text>
                </TouchableWithoutFeedback>
            </View>
                ...
                >
                    ...
                    >
                        <View style={styles.description}>
                            <Text style={[styles.text, styles.textDescription]}>Wallet Balance</Text>
                            <Icon
                                svg={Wallet}
                                fill="#171717"
                                height="40px"
                ...
                >
                    ...
                    >
                        ...
                        <View style={[
                            ...
                            <Text style={[styles.text, styles.textDescription]}>Income</Text>
                ...
                >
                    ...
                    >
                        ...
                        <View style={[
                            ...
                            <Text style={[styles.text, styles.textDescription]}>Expenses</Text>
                            <Text numberOfLines={1} style={[
                                styles.text,
                                styles.textAmount,
                                {
                ...
                >
                    ...
                    >
                        ...
                        <View style={[
                            ...
                            <Text style={[styles.text, styles.textDescription]}>To Receive</Text>
                            <Text numberOfLines={1} style={[
                                styles.text,
                                styles.textAmount,
                                {
                ...
                >
                    ...
                    >
                        ...
                        <View style={[
                            ...
                            <Text style={[styles.text, styles.textDescription]}>Debts</Text>
                            <Text numberOfLines={1} style={[
                                styles.text,
                                styles.textAmount,
                                {
                ...
                <View style={styles.sectionContainer}>
                    ...
                    >
                        <View style={[
                            ...
                            <Text numberOfLines={1} style={styles.text}>Recent Transactions</Text>
                            <Icon
                                svg={UpRight}
                                fill="#050505"
                                height="16px"
                ...
                <View style={styles.sectionContainer}>
                    ...
                    >
                        <View style={[
                            ...
                            <Text numberOfLines={1} style={styles.text}>Receivables and Debts</Text>
                            <Icon
                                svg={UpRight}
                                fill="#050505"
                                height="16px"
                ...
                <View style={styles.sectionContainer}>
                    ...
                    >
                        <View style={[
                            ...
                            <Text numberOfLines={1} style={styles.text}>Receiving Soon</Text>
                            <Icon
                                svg={UpRight}
                                fill="#050505"
                                height="16px"
                ...
                <View style={styles.sectionContainer}>
                    ...
                    >
                        <View style={[
                            ...
                            <Text numberOfLines={1} style={styles.text}>Paying Soon</Text>
                            <Icon
                                svg={UpRight}
                                fill="#050505"
                                height="16px"
                ...
                <View style={styles.sectionContainer}>
                    ...
                    >
                        <View style={[
                            ...
                            <Text numberOfLines={1} style={styles.text}>Not Paid</Text>
                            <Icon
                                svg={UpRight}
                                fill="#050505"
                                height="16px"
                ...
                <View style={styles.sectionContainer}>
                    ...
                    >
                        <View style={[
                            ...
                            <Text numberOfLines={1} style={styles.text}>Not Received</Text>
                            <Icon
                                svg={UpRight}
                                fill="#050505"
                                height="16px"
